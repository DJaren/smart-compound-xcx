<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="buildingList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="楼号" align="center" prop="buildNum" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="楼号" prop="buildNum">
          <el-input v-model="form.buildNum" placeholder="请输入楼号" />
        </el-form-item>
      </el-form>
...
<script>
import { listBuilding, getBuilding, delBuilding, addBuilding, updateBuilding, exportBuilding } from "@/api/system/building";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除楼栋信息编号为"' + ids + '"的数据项?', "警告", {
